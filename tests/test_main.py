...
class Test_Dataloaders:
    def test_image_list_length(self):
        train_list = ImageFilelist('tests/data/prepared-plants', 'tests/data/prepared-plants/train.json')
        assert train_list.total_images == 664
        val_list = ImageFilelist('tests/data/prepared-plants', 'tests/data/prepared-plants/val.json')
